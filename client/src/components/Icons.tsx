...
/**
 * QuickCart Brand Logo Mark
 * Ultra-sleek minimalist geometric 'Q' with integrated cart speed slash
 */
export const LogoIcon: React.FC<IconProps> = ({ size = 24, className = '', ...props }) => (
  <svg
    ...
    {...props}
  >
    {/* Outer Rounded Container / Ring */}
    <rect width="32" height="32" rx="10" fill="currentColor" fillOpacity="0.1" />
    <path
      d="M10 9C8.34315 9 7 10.3431 7 12V20C7 21.6569 8.34315 23 10 23H17L22 25.5V23C23.6569 23 25 21.6569 25 20V12C25 10.3431 23.6569 9 22 9H10Z"
      stroke="currentColor"
      strokeWidth="2.2"
      strokeLinecap="round"
    ...
    />
    <path
      d="M11 16L15 12M15 12H11.5M15 12V15.5"
      stroke="currentColor"
      strokeWidth="2.2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
/** Shopping Cart Icon */
export const CartIcon: React.FC<IconProps> = ({ size = 20, className = '', ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
/** Shop / Store Bag Icon */
export const ShopIcon: React.FC<IconProps> = ({ size = 20, className = '', ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
/** Admin / Lightning Icon */
export const AdminIcon: React.FC<IconProps> = ({ size = 20, className = '', ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
